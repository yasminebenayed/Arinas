                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Table des clients</h6>
                            </div>
                        </div>
                                ...
                                <table class="table align-items-center mb-0">
                                    <thead style="text-align:center">
                                        <tr>
                                            ...
                                            <th
                                                class="text-secondary opacity-7">
                                                Adresse</th>
                                            <th class="text-secondary opacity-7">Commandes</th>
                                        </tr>
                                    </thead>
                                    <tbody style="text-align:center">
                                        ...
                                        foreach($users as $u) {
                                            ...
                                            echo "<td>";
                                            echo "<a href='commandes.php?codeUser=". $u->code . "' class='view' title='View' data-toggle='tooltip'><i class='material-icons'>&#xE417;</i></a>";
                                            echo "</td>";
                                            echo "</tr>";
                                        }
                                        ?>
