...
.container-small {
  ...
  padding: 10px; /* Réduisez les marges internes */
  margin: 0 auto; /* Centrez si nécessaire */
}
.h1-small {
  font-size: 70px; /* Réduisez la taille */
  margin:0; /* Ajustez les marges */
  padding:0px;
}
.custom-navbar {
  margin-left: 0px; /* Exemple : ajuster la marge */
  font-size: 14px; /* Réduction de la taille du texte */
  background-color: #f8f9fa; /* Couleur de fond supplémentaire */
  padding: 0px 0px; /* Ajustement du padding */
...
<ul class="cat-list">
  ...
  <h1 class="section-title text-center mt-4 aos-init aos-animate h1-small">    <p class="a">Arinas</p>
  </h1>
</div>
